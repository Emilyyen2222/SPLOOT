...
<!-- 主要功能 -->
 <div class="splootBuddy">
    ...
    <div class="btnBox buddytSearch">
        <div class="btn default blue"><span>搜尋</span></div>
    </div>
    ...
    <div class="middleSection">
        <div class="toBeBuddy">
            ...
            <div class="btnBox">
                <div class="btn outline small textBlue howToBe"><span class="xsText bold">成為小幫手</span></div>
            </div>
        </div>        
        <!-- 行程按鈕 -->       
