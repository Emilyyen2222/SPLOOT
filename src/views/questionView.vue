...
<div v-if="question==7" class="boxSubPlan">
    <div class="questionContainer">
        ...
        <div class="container">
                ...
                <div class="card"
                :class="{'-active': subSelected == '3個月'}"
                @click="subToggle('3個月')">
                    <div class="image">
                        <img src="@/assets/img/icon/giftIcon.svg"  alt="">
                    </div>
                    <h6 class="times">x3</h6>
                    <h6 class="subMonths">3個月</h6>
                    <h6 class="price">＄2,097</h6>
                </div>
                <div class="card"
                :class="{'-active': subSelected == '6個月'}"
                @click="subToggle('6個月')">
                    <div class="image">
                        <img src="@/assets/img/icon/giftIcon.svg"  alt="">
                    </div>
                    <h6 class="times">x6</h6>
                    <h6 class="subMonths">6個月</h6>
                    <h6 class="price">＄3,774</h6>
                </div>
                <div class="card popular"
...
<div v-if="question==8" class="box">
    <div class="questionContainer">
        ...
        <Btn btnType="form" btnStyle="nextQ"
        @click="nextQuestion(q8input != '')">下一題</Btn> 
        <Btn btnType="form" btnStyle="lastQ"
        @click="lastQuestion">上一題</Btn>  
    </div>
</div>
    ...
    <div class="questionContainer">
        ...
        <div class="options">
            ...
            <div class="infoBox">
                ...
                <InputText size = "small" placeHolder="卡號" errorMsg="Invalid Input" 
                v-model="inputValue" :hasError="inputError">
                </InputText>
                <InputText size = "small" placeHolder="持卡人姓名" errorMsg="Invalid Input" 
                v-model="inputValue" :hasError="inputError">
                </InputText>
                <div class="cardInfo">
                    <div class="info">
                    ...
                    <div class="info">
                    <InputText size = "small" placeHolder="安全碼" errorMsg="Invalid Input" 
                    v-model="inputValue" :hasError="inputError">
                    </InputText>
                    </div>
                </div>
            ...
            <li class="checkBox">
                <div class="boxAlign">
                    ...
                    <p class="xsText">
                        我同意 
                        <span class="xsText link" @click="togglePopUp" href="">網站服務條款</span> 及 
                        <span class="xsText link" @click="togglePopUp" href="">隱私權政策</span>
                    </p>
                </div>
                <div class="boxAlign">
                    <input type="checkbox">
