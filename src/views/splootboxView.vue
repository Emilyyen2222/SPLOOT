...
<div class="page-splootbox">
    ...
    <div class="herobox">
        ...
        <div class="herobtn">
            <h4 class="bold">耶誕寵愛升級，專屬毛孩的驚喜時刻</h4>
            <div class="btnBox">
    ...
    <div class="boxContainer">
        ...
        <div class="boxSection">
            ...
            <div class="boxText">
                ...
                <p class="default">趣味互動，增強智力與活力，陪伴毛孩快樂消耗精力！</p>
            </div>
        </div>
    </div>
    <div class="bigTitle">
        <div class="boxTitle">
            <h4 class="bold">如何訂閱SLPOOT BOX</h4>
            <p class="bigText">How it works</p>
        </div>
    </div>
    <!-- 如何訂閱區塊 -->
    ...
    <div class="reviewTitle">
            <h4 class="bold">狗狗給我們的評語</h4>
            <p class="feedback-content">
                拿到我們的 SPLOOT BOX 訂閱盒後，記得與毛孩一起留下這段幸福時光！拍下狗狗與盒子合影，或錄製牠興奮開箱的可愛瞬間，並將照片或影片發布給我們。<br/><br/>
                完成分享後，還能獲得專屬積分，累積積分兌換更多驚喜好禮！讓每個開箱時刻都成為珍貴的回憶，同時與我們一起分享這份快樂吧！
            </p>
            <!-- circle bg -->
    ...
    <div class="reviews-container">
        <div class="review-card">
            ...
            <div class="review-content">
                <p class="bold">Emily</p>
                <p class="review-text">
                    SPLOOT BOX 的零食真的讓人安心！不僅好吃又健康，還特別符合節日的主題，我家狗狗吃完後心情都變超好！
                </p>
            </div>
        </div>
        <div class="review-card">
            <div class="review-image">
                <img src="@/assets/img/splootbox/dogbox1.avif"  alt="">
            </div>
            <div class="review-content">
                <p class="bold">Sam</p>
                <p class="review-text">
                    超愛這次的聖誕SPLOOT BOX，尤其是聖誕餅乾，每次吃完都搖著尾巴要求再來一塊！
                </p>
            </div>
        </div>
        <div class="review-card">
            <div class="review-image">
                <img src="@/assets/img/splootbox/reviewcard2.jpg"  alt="">
            </div>
            <div class="review-content">
                <p class="bold">Lupe</p>
                <p class="review-text">
                    每次打開包裹，Coco 都興奮得搖尾狂奔！玩具跟用品都很適合她的小短腿，愛了！💖
                </p>
            </div>
        </div>
        <div class="review-card">
            <div class="review-image">
                <img src="@/assets/img/splootbox/reviewcard3.jpg"  alt="">
            </div>
            <div class="review-content">
                <p class="bold">Ian</p>
                <p class="review-text">
                    Momo 超挑剔，但這次的點心她一口氣吃光，還對新玩具愛不釋手，根本量身打造！期待下次驚喜！🐶
                </p>
            </div>
        </div>
    </div>
